			...
			<div id="title">
				...
				<s:form action="LoginAction">
					<div>ログイン情報を入力してください</div>
						<table>
							<tr>
								<td><s:textfield name="email" placeholder="メール" id="text"/></td>
							</tr>
							<tr>
								<td><s:password name="password" placeholder="パスワード" id="text"/></td>
							</tr>
						</table>
							<br>
						<div id="button">
				...
				<div id="error">
					<br>
						<s:property value="emailError"/><s:if test="emailError!=null"><br></s:if>
						<s:property value="passwordError"/><s:if test="passwordError!=null"><br></s:if>
						<s:property value="inputError"/>
				</div>

				新規ユーザー登録は<a href='<s:url action = "UserCreateMoveAction" />'>こちら</a>
				<br><br>
				パスワードを忘れた方は<a href='<s:url action = "ResetUserPassMoveAction" />'>こちら</a>
	</div>
			<br>
		<footer>
